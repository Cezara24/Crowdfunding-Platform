...
const EmailNewsletterIcon = tw(EmailNewsletterIconBase)`w-16 h-16 text-cyan-500`
...
const Button = tw(PrimaryButton)`w-full sm:w-auto mt-6 sm:mt-0 sm:rounded-l-none py-4 bg-cyan-500 text-gray-100 hocus:bg-cyan-700 hocus:text-gray-300 border border-cyan-500 hocus:border-cyan-700`
        ...
        <Row>
          <TextColumn>
            ...
            <HeadingInfoContainer>
              ...
              <Description>Abonează-te și rămâi la curent cu cele mai noi inițiative</Description>
            </HeadingInfoContainer>
          </TextColumn>
          <FormColumn>
          <Form>
            <Input name="newsletter" type="email" placeholder="Adresa ta de email" />
